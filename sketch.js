...
function preload(){
  trex_running = loadAnimation("sonic-the-hedgehog-class-8-bit-sonic-runni-11562942747zjec3cvnxf.png","199-1995607_sonic-running.png");
  trex_collided = loadAnimation("sonic-mania-pixel-art-maker-337812.png");
...
function setup() {
  ...
  invisibleGround = createSprite(200,190,370,20);
  ...
  trex.setCollider("rectangle",0,0,1000,1000);
  trex.debug = false;
